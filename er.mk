...
PRODUCT_COPY_FILES += \
	$(VENDOR_DIR)/config/magisk/init.er-pi.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/init.er-pi.rc \
	$(VENDOR_DIR)/config/magisk/er-preinstaller.sh:$(TARGET_COPY_OUT_VENDOR)/bin/er-preinstaller
